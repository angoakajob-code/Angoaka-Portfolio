    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="mb-8 relative">
          {/* Conteneur vertical avec espacement contrôlé */}
          <div className="flex flex-col items-center">
            ...
            {/* Titre ANGOAKA avec lettres SVG individuelles - avec marge négative pour rapprocher */}
            <div className="flex justify-center items-center gap-2 md:gap-4 relative -mt-30 sm:-mt-32 md:-mt-40 lg:-mt-48">
